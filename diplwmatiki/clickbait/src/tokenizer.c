...
#define LEN 64819
#define LEN_END 64820

/*
cd into bin
compile: gcc ../src/tokenizer.c ../src/lib/tokenizer_helper.c ../src/lib/add_to_list.c  ../src/lib/configure_database_helper.c `mysql_config --cflags --libs` -o tokenizer
...
postMedia = calloc(500, sizeof(char));
title = calloc(1024, sizeof(char));
description = calloc(2000, sizeof(char));
keywords = calloc(1024, sizeof(char));
paragraphs = calloc(8000, sizeof(char));
captions = calloc(8000, sizeof(char));


fd = open("../docs/instances00.json", O_RDONLY);
